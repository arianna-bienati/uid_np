...
Generalized additive regression models for the UID measure UIDev (average of surprisal differences).
...
## Fit model with sampled data: uid_dev

Fit a generalized linear model model with interaction of year and NP length and random intercepts for head noun lemma and author.

```{r}
# model with random intercept
gam_sigma_1 <- mgcv::bam(uid_dev ~ s(year_c)
                       + s(NP_len)
...
cat("model_summary", output, file="C:/Users/isabell/Documents/UdS/Corpus_Analysis/RSC/fluctuation_complexity/results/20250820_uid_dev_gam/model_summary.txt", sep="\n", append=TRUE)
```
