...
```{r}
saveRDS(gam_sigma_1, "C:/Users/isabell/Documents/UdS/Corpus_Analysis/RSC/fluctuation_complexity/results/20250820_sigma_gam/gam_sigma_1.rds")
```

Load model.

```{r}
gam_sigma_1 <- readRDS("C:/Users/isabell/Documents/UdS/Corpus_Analysis/RSC/fluctuation_complexity/results/20250820_sigma_gam/gam_sigma_1.rds")
```
...
cat("model_summary", output, file="C:/Users/isabell/Documents/UdS/Corpus_Analysis/RSC/fluctuation_complexity/results/20250820_sigma_gam/model_summary.txt", sep="\n", append=TRUE)
```
