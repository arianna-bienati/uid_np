...
Model 1: Fit a simple model with interaction of year and NP length and random intercepts for head noun lemma and author.
...
DHARMa::plotResiduals(sim_lm_sigma_1, form = data_sample$year_c) # plot residuals against predictor
```
