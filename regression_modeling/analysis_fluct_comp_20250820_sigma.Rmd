...
write.csv(cv_results, file = "./results/20250820_sigma/cv_results.csv")
```
...
cat("model_summary", output, file="./results/20250820_sigma/model_summary.txt", sep="\n", append=TRUE)
...
# plot effect of NP length and sum of surprisal (version 1)
...
# plot effect of NP length and sum of surprisal (version 2)
ggeffects::ggeffect(lm_sigma_final, c("NP_len_c","avg_srp_c[0.3173475,2.817347,5.317347]")) %>%
  plot() +
